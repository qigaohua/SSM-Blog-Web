...
<title>登录</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/normalize.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/login.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/sign-up-login.css">
<link rel="stylesheet" type="${pageContext.request.contextPath}/static/loginPages/text/css" href="${pageContext.request.contextPath}/static/loginPages/css/font-awesome.min.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/inputEffect.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/tooltips.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/loginPages/css/spop.min.css" />

<script src="${pageContext.request.contextPath}/static/loginPages/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/static/loginPages/js/snow.js"></script>
<script src="${pageContext.request.contextPath}/static/loginPages/js/jquery.pure.tooltips.js"></script>
<script src="${pageContext.request.contextPath}/static/loginPages/js/spop.min.js"></script>
<script>	
	(function() {
			...
			$.post("/blog/register", {username: username, password: password, repassword: repassword, email: code}, 
					function(result) {
						if (result.success) {
				 			...
				 			spop({			
								template: '<h4 class="spop-title">注册失败</h4>' + result.errMsg,
								position: 'top-center',
								style: 'error',
								autoclose: 5000,
								onOpen : function(){
									...
									var showPop = setInterval(function(){
										...
										$('.spop-body').html('<h4 class="spop-title">注册失败</h4>' + result.errMsg);
										second--;
									},1000);
								},
								onClose : function(){									
...
body{
	...
	background-image: url(${pageContext.request.contextPath}/static/loginPages/images/snow.jpg);
				...
				<form action="#" method="post" class="container offset1 loginform">
					...
					<div class="pad input-container">
						<section class="content">
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-code" autocomplete="off" placeholder="请输入你的邮箱"/>
